...
// import "highlight.js/styles/github-dark.css"; // Dark theme always
...
//     return `
// You are a helpful DSA tutor. Given a question, do the following:
// 1. Understand and explain the problem in simple terms.
// 2. Provide a brute-force solution with time & space complexity.
// 3. Then improve it step-by-step to an optimal solution.
// 4. Give C++ code for both solutions.
// 5. Add comments to the code for clarity.
// 6. Output time & space complexity of both approaches.
// Question:
// ${question}
//     `;
//   };
...
//         </div>
//         <main className="flex-grow min-h-[70vh] overflow-y-auto px-2 sm:px-4 py-6 space-y-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
...
//               )}
//               <div
//                 className={`w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[75%] xl:max-w-[70%] whitespace-pre-wrap p-4 rounded-2xl shadow ${
//                   msg.role === "user"
...
//           className={`sticky bottom-0 px-4 py-4 flex items-center gap-3 ${
//             theme === "dark"
